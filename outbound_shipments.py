...
columns = ["pallet_number", "ship_order_code", "ship_order_reference_number", "ship_order_customer_name", "carrier_code", "trailer_number", "item_code", "item_category_name", "actual_ship_at"]
